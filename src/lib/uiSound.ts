...
export function playUiSound(id: UiSoundId): void {
  ...
  switch (id) {
    case 'soft':
      tone(c, { type: 'sine', freq: 720, gain: 0.12, duration: 0.09 })
      break
    case 'pop':
      tone(c, { type: 'triangle', freq: 520, freqEnd: 940, gain: 0.14, duration: 0.12 })
      break
    case 'tick':
      tone(c, { type: 'square', freq: 1200, gain: 0.08, duration: 0.04 })
      break
    case 'bell':
